...
>   https://raw.githubusercontent.com/chasqui-stack/chasqui/v0.5.1/docs/MODULES.md
> - **Architecture §8** (Tool Registry — §8.1 how a tool is defined, §8.2 the
>   module contract, §8.3 the reusable archetype):
>   https://raw.githubusercontent.com/chasqui-stack/chasqui/v0.5.1/docs/ARCHITECTURE.md
> - **Worked example:** https://raw.githubusercontent.com/chasqui-stack/chasqui/v0.5.1/docs/design/module-example-commercial-locations.md
