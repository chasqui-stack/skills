...
> this stack release (v0.4.0):
> - **Canonical contract** (inbound `/ingest` shape, media as base64 data URIs):
>   https://raw.githubusercontent.com/chasqui-stack/chasqui/v0.4.0/docs/ARCHITECTURE.md  (§5)
> - **Outbound seam** (`POST /send`, conversation mode / human handoff):
>   §5.1 of the same doc + ADR-004:
>   https://raw.githubusercontent.com/chasqui-stack/chasqui/v0.4.0/docs/design/adr-004-conversation-mode-outbound-send.md
> - **Worked example decision** (Telegram, library + webhook integration):
>   https://raw.githubusercontent.com/chasqui-stack/chasqui/v0.4.0/docs/design/adr-006-telegram-channel.md
> - **Second archetype decision** (web: Node monolith, anonymous identity, SSE,
>   rehydration) — ADR-011:
>   https://raw.githubusercontent.com/chasqui-stack/chasqui/v0.4.0/docs/design/adr-011-web-channel.md
...
1. **Python/FastAPI gateway** — the default, for platforms with their own client
   ...
   - Telegram: https://github.com/chasqui-stack/telegram (tag `v0.4.0`) — `app/main.py`,
     `app/handlers/`, `app/services/`, `app/core/`.
   - WhatsApp: https://github.com/chasqui-stack/whatsapp (tag `v0.4.0`).
